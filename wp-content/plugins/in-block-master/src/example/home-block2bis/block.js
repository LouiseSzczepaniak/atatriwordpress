...
const BLOCK_NAME = `${PLUGIN_NAME}/home-block2bis`

registerBlockType(BLOCK_NAME, {
  title: __('Home block 2 bis'),
...
<PlainText
  ...
  save: ({ attributes: { title1, title2, text, linkname, link, imageUrl } }) => (
    <>
      <div class="section-4">
<div class="haricot-jaune"></div>
<img src={imageUrl} class="img-1"></img>
<div class="text-4"><h1>{title1}</h1>
<h2>{title2}</h2>
<p>{text}</p>
<a href={link}><input type="button" class="input-button-3" value={linkname}/></a>
</div>
</div>
    </>
  )
